  ...
  setup(props) {
    ...
    return {
      buttonClass: computed(() => ({
        ...
        "bg-yellow-base hover:bg-yellow-dark": props.theme === "warning",
        "bg-red-base hover:bg-red-dark": props.theme === "danger",
        "bg-purple-base hover:bg-purple-dark": props.theme === "help",
